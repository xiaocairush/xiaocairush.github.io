...
REST (Representational State Transfer)是由[Roy Fielding](https://en.wikipedia.org/wiki/Roy_Fielding)2000年发表的[博士论文](https://www.ics.uci.edu/~fielding/pubs/dissertation/top.htm)提出的。REST并非标准，而是由一系列约束组成，例如无状态，C/S模式以及风格一致的接口。REST与HTTP没有必然的联系。
